...
$(function() {
	...
	describe('Initial Entries', function() {
		...
		it('will be populated on page loads, which is the very first item in array containing entries', function() {
	...
	describe('New Feed Selection', function() {
		...
		it('has a test that ensures when a news feed is loaded by the loadFeed function and that the content actually changes when another feed is loaded', function() {

			// save the entire news feed for a comparison later
			oldContent = $('.feed').html();
			expect($('.feed')).toBeInDOM();
		});
		describe('has a test that is loading the new feed of data to loadFeed()...', function() {
			...
			it('now the data has changed', function() {
